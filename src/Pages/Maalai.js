...
const Maalai = () => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const q = query(productsCollection, where("page", "==", "Maalai"));
  ...
  const renderProductCard = (product) => (
    <div key={product.id} className="flex-shrink-0 px-2" style={{ width: '80%', maxWidth: '300px' }}>
